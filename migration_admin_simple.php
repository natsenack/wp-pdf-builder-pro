<?php
/**
 * Page admin de migration simplifiée pour diagnostic
 */
...
// Enregistrer la page admin directement
add_action('admin_menu', function() {
    add_submenu_page(
        ...
        'pdf_builder_migration_page_simple'
    );
});

function pdf_builder_migration_page_simple() {
    ...
    <div class="wrap">
        ...
        <div id="diagnostic-info">
            ...
            <ul>
                <li>Utilisateur actuel: <?php echo wp_get_current_user()->display_name; ?></li>
                <li>Capacité manage_options: <?php echo current_user_can('manage_options') ? 'Oui' : 'Non'; ?></li>
                <li>Plugin activé: <?php echo is_plugin_active('wp-pdf-builder-pro/pdf-builder-pro.php') ? 'Oui' : 'Non'; ?></li>
                <li>Page actuelle: <?php echo isset($_GET['page']) ? $_GET['page'] : 'N/A'; ?></li>
                <li>AdminPages.php chargé: <?php echo class_exists('PDFBuilderPro\\V2\\AdminPages') ? 'Oui' : 'Non'; ?></li>
            </ul>
        </div>
