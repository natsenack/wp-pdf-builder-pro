...
class PDF_Builder_Loader {
    ...
    private function load_security_components() {
        $this->require_file('src/backend/security/Security/security-manager.php');
        $this->require_file('src/backend/security/Security/sanitizer.php');
    }
    ...
    private function load_core() {
        $this->require_file('src/backend/core/Core/PDF_Builder_Core.php');
        $this->require_file('src/backend/core/Core/constants.php');
        $this->require_file('src/backend/core/Core/TemplateDefaults.php');
    }
    ...
    private function load_managers() {
        ...
        foreach ($managers as $manager) {
            $this->require_file('src/backend/utilities/Managers/' . $manager);
        }
    ...
    private function load_utilities() {
        ...
        foreach ($utilities as $utility) {
            $this->require_file('src/backend/utilities/Utilities/' . $utility);
        }
    }
    ...
    private function load_ajax_handlers() {
        $this->require_file('src/backend/api/AJAX/Ajax_Handlers.php');
        $this->require_file('src/backend/admin/Admin/Canvas_AJAX_Handler.php');
    }
    ...
    private function load_api_endpoints() {
        ...
        $this->require_file('src/backend/api/AJAX/preview-image-handler.php');
    }
    ...
    private function load_admin_interface() {
        $this->require_file('src/backend/admin/Admin/PDF_Builder_Admin.php');
    }
