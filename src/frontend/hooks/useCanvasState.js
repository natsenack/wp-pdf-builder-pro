...
import { ELEMENT_TYPE_MAPPING, fixInvalidProperty } from '../utils/elementPropertyRestrictions.js';
...
export const useCanvasState = ({
  ...
  const addElement = useCallback((elementType, properties = {}) => {
    ...
    const defaultProps = {
      ...
      showDiscount: false,
      showTotal: false,
      tableStyle: 'default', // Thème de base
      tableColorPrimary: '', // Vide = utiliser la couleur du thème
      tableColorSecondary: '', // Vide = utiliser la couleur du thème
  ...
  return useMemo(() => ({
    // État
    elements,
    canvasWidth: pointsToPixels(canvasWidth), // Conversion points → pixels
    canvasHeight: pointsToPixels(canvasHeight), // Conversion points → pixels
