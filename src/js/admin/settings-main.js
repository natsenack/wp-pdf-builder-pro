...
(function ($) {
  ...
  window.deactivateLicense = function () {
    ...
    form.append(
      $("<input>", {
        ...
        value:
          window.pdfBuilderLicense && window.pdfBuilderLicense.deactivateNonce
            ? window.pdfBuilderLicense.deactivateNonce
            : "",
      }),
    );
  ...
  $(document).on("click", "#pdf-builder-save-floating-btn", function (e) {
    ...
    $("#pdf-builder-settings-form").append(
      $("<input>", {
        type: "hidden",
    ...
    var addedField = $(
      '#pdf-builder-settings-form input[name="pdf_builder_floating_save"]',
    );
  ...
  $(document).on("submit", "#pdf-builder-settings-form", function (e) {
    ...
    if (floatingField.length) {
      console.log(
        "Floating save field found with value: " + floatingField.val(),
      );
    } else {
