...
class PDF_Builder_Admin {
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // Scripts JavaScript
        wp_enqueue_script('pdf-builder-admin', PDF_BUILDER_PRO_ASSETS_URL . 'js/dist/pdf-builder-admin.js', ['jquery', 'wp-api'], PDF_BUILDER_PRO_VERSION . '_v3', true);
        ...
        wp_localize_script('pdf-builder-admin', 'pdfBuilderAjax', [
            ...
            'nonce' => wp_create_nonce('pdf_builder_canvas_v3_' . get_current_user_id()),
            'strings' => [
