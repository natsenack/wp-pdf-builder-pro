...
const testCanvasIntegration = () => {
    console.log('=== Test d\'intégration du canvas avec dédoublonnement ===');

    // Simuler une instance de PDFCanvasVanilla avec les nouvelles méthodes
    const mockCanvas = {
        elements: new Map(),
        historyManager: {
