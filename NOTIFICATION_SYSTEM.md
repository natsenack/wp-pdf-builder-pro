...
3. ✅ Intégration WordPress
4. ✅ **FAIT**: Notifications dashboard (optimisation DB, cache, fichiers temp - settings-systeme.php)
5. ✅ **FAIT**: Notifications licence (admin_notices WordPress via form submit)
6. ✅ **FAIT**: Notifications backup/restore (création, restauration, suppression - settings-systeme.php)
7. ✅ **FAIT**: Notifications bouton flottant "Enregistrer" (settings-main.php)
8. 🎯 **Optionnel**: Ajouter aux générateurs PDF
9. 🎯 **Optionnel**: Ajouter à import/export templates
10. 🎯 **Optionnel**: Ajouter aux actions GDPR
