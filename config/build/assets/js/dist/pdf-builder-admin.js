...
// EXTERNAL MODULE: ./resources/js/components/preview-system/PreviewModal.jsx + 13 modules
var PreviewModal = __webpack_require__(830);
  ...
  if (PDFBuilderSecurity.performHealthCheck()) {
    ...
    window.pdfBuilderShowPreview = function (orderId, templateId, nonce) {
      ...
      try {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 830)).then(function (_ref2) {
...
var PreviewModal = function PreviewModal(_ref) {
  ...
  try {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      className: "preview-modal-header"
    }, /*#__PURE__*/react.createElement("h3", null, "\u274C Erreur d'aper\xE7u"), /*#__PURE__*/react.createElement("button", {
      className: "preview-modal-close",
      onClick: handleButtonClose,
      title: "Fermer l'aper\xE7u"
    }, "\xD7")), /*#__PURE__*/react.createElement("div", {
      ...
      className: "preview-error"
    }, /*#__PURE__*/react.createElement("p", null, "Une erreur s'est produite lors du rendu de l'aper\xE7u."), /*#__PURE__*/react.createElement("p", null, "D\xE9tails: ", renderError.message), /*#__PURE__*/react.createElement("button", {
      onClick: function onClick() {
        return window.location.reload();
      },
      className: "preview-retry-btn"
