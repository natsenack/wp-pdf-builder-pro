"use strict";
(self["webpackChunkPDFBuilderPro"] = self["webpackChunkPDFBuilderPro"] || []).push([[350],{
...
// EXTERNAL MODULE: ./resources/js/components/preview-system/hooks/usePerformanceMonitor.js
var usePerformanceMonitor = __webpack_require__(325);
// EXTERNAL MODULE: ./resources/js/components/preview-system/renderers/PDFRenderer.jsx
var PDFRenderer = __webpack_require__(813);
// EXTERNAL MODULE: ./resources/js/components/preview-system/utils/previewUtils.js
var previewUtils = __webpack_require__(438);
...
function CanvasRenderer(_ref) {
  ...
  var _usePerformanceMonito = (0,usePerformanceMonitor.usePerformanceMonitor)('CanvasRenderer'),
    measureOperation = _usePerformanceMonito.measureOperation;

  // Dimensions de la page
  var pageDims = (0,previewUtils.getPageDimensions)('A4', 96);
  ...
  (0,react.useEffect)(function () {
    var handleResize = function handleResize() {
      if (containerRef.current && canvasRef.current) {
        ...
        var canvas = canvasRef.current;
        var optimalZoom = (0,previewUtils.calculateOptimalZoom)({
...
function NavigationControls(_ref) {
  ...
  var _usePerformanceMonito = (0,usePerformanceMonitor.usePerformanceMonitor)('NavigationControls'),
    measureOperation = _usePerformanceMonito.measureOperation;
...
function MetaboxMode(_ref) {
  ...
  var _usePerformanceMonito = (0,usePerformanceMonitor.usePerformanceMonitor)('MetaboxMode'),
    measureOperation = _usePerformanceMonito.measureOperation;
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    switch (element.type) {
      case 'pdf':
        return /*#__PURE__*/react.createElement(PDFRenderer["default"], {
          key: element.id,
          element: element,
          previewData: previewData,
          mode: "metabox"
