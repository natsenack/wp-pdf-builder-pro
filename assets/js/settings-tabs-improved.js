...
(function() {
    ...
    function debugElements() {
        ...
        log('PDF Builder - DIAGNOSTIC DES ÉLÉMENTS DOM:');
    ...
    function onDOMReady() {
        log('PDF Builder - DOM CONTENT LOADED - Démarrage de l\'initialisation');
        
        // Attendre que tous les scripts soient chargés
        setTimeout(function() {
            log('PDF Builder - TIMEOUT - Lancement de l\'initialisation différée');
            initializeTabs();
        }, 100);
    }
