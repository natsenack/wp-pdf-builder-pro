...
const TemplateHeaderBar = ({
  ...
  // Récupérer les dimensions par défaut depuis les paramètres du plugin
  const getDefaultDimensions = () => {
    const canvasSettings = window.pdfBuilderCanvasSettings || {};
    return {
      width: canvasSettings.default_canvas_width || 794, // A4 width par défaut
      height: canvasSettings.default_canvas_height || 1123 // A4 height par défaut
    };
  };
  ...
  const handleCreateNew = () => {
    ...
    // Reset form avec les dimensions par défaut du plugin
    setNewTemplateData({
      name: '',
      ...getDefaultDimensions(),
      orientation: 'portrait'
