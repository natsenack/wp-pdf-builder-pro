/**
 * PDF Builder React Wrapper - V1 FULL REPLICA WITH PROPERTIES PANEL
 */

(function() {
  'use strict';

  console.log('[PDF Builder] React Wrapper initializing - V1 FULL REPLICA');
    ...
    initPDFBuilderReact: function(config) {
      ...
      const PropertiesPanel = function() {
        return window.React.createElement('div', {
          ...
          window.React.createElement('div', { style: { padding: '12px', borderBottom: '1px solid #e0e0e0', fontWeight: 600, fontSize: '13px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
            window.React.createElement('span', null, ' Propriétés (0)'),
          ...
          window.React.createElement('div', { style: { flex: 1, overflow: 'auto', padding: '12px' } },
            ...
            // Onglets pour les propriétés
            window.React.createElement('div', { style: { marginTop: '16px', display: 'flex', gap: '2px', borderBottom: '2px solid #ddd' } },
              window.React.createElement('button', { style: { flex: 1, padding: '8px 6px', backgroundColor: '#f0f0f0', color: '#333', border: 'none', cursor: 'pointer', fontSize: '11px', fontWeight: 'bold', borderRadius: '3px 3px 0 0' } }, 'Fonctionnalités'),
              window.React.createElement('button', { style: { flex: 1, padding: '8px 6px', backgroundColor: '#f0f0f0', color: '#333', border: 'none', cursor: 'pointer', fontSize: '11px', fontWeight: 'bold', borderRadius: '3px 3px 0 0' } }, 'Personnalisation'),
              window.React.createElement('button', { style: { flex: 1, padding: '8px 6px', backgroundColor: '#f0f0f0', color: '#333', border: 'none', cursor: 'pointer', fontSize: '11px', fontWeight: 'bold', borderRadius: '3px 3px 0 0' } }, 'Positionnement')
            ),
            // Propriétés communes
            window.React.createElement('div', { style: { marginTop: '12px', display: 'grid', gap: '8px' } },
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Position X'),
                window.React.createElement('input', { type: 'number', disabled: true, style: { width: '100%', padding: '4px 6px', border: '1px solid #ccc', borderRadius: '3px', fontSize: '11px' } })
              ),
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Position Y'),
                window.React.createElement('input', { type: 'number', disabled: true, style: { width: '100%', padding: '4px 6px', border: '1px solid #ccc', borderRadius: '3px', fontSize: '11px' } })
              ),
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Largeur'),
                window.React.createElement('input', { type: 'number', disabled: true, style: { width: '100%', padding: '4px 6px', border: '1px solid #ccc', borderRadius: '3px', fontSize: '11px' } })
              ),
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Hauteur'),
                window.React.createElement('input', { type: 'number', disabled: true, style: { width: '100%', padding: '4px 6px', border: '1px solid #ccc', borderRadius: '3px', fontSize: '11px' } })
              ),
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Rotation (°)'),
                window.React.createElement('input', { type: 'number', disabled: true, style: { width: '100%', padding: '4px 6px', border: '1px solid #ccc', borderRadius: '3px', fontSize: '11px' } })
              ),
              window.React.createElement('div', null,
                window.React.createElement('label', { style: { display: 'block', fontSize: '11px', fontWeight: 600, marginBottom: '4px', color: '#666' } }, 'Opacité'),
                window.React.createElement('input', { type: 'range', min: '0', max: '1', step: '0.1', disabled: true, style: { width: '100%' } }),
                window.React.createElement('span', { style: { fontSize: '10px', color: '#999' } }, '100%')
              )
            )
          )
        );
      ...
      try {
        if (typeof window.ReactDOM.render === 'function') {
          ...
          console.log('[PDF Builder] Editor V1 replica rendered successfully (React 16-17)');
        } else if (typeof window.ReactDOM.createRoot === 'function') {
          const root = window.ReactDOM.createRoot(container);
          root.render(EditorApp);
          console.log('[PDF Builder] Editor V1 replica rendered successfully (React 18+)');
        }
        return true;
      } catch (error) {
  ...
  console.log('[PDF Builder] React Wrapper loaded (V1 FULL REPLICA)');
})();