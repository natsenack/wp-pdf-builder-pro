          ...
          window.React.createElement('div', { 
            ...
            canvasElements.map((elem) => {
              ...
              if (elem.type === 'text') {
                ...
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', color: '#666', fontSize: '11px', fontWeight: 'bold', padding: '4px', boxSizing: 'border-box', textAlign: 'center' } }, 
                  window.React.createElement('div', { style: { fontSize: '16px', marginBottom: '2px' } }, '▭'),
                  window.React.createElement('div', { style: { fontSize: '9px' } }, (elem.label || 'Rectangle').substring(0, 12))
                );
              } else if (elem.type === 'circle') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', color: '#666', fontSize: '11px', fontWeight: 'bold', padding: '4px', boxSizing: 'border-box', textAlign: 'center' } },
                  window.React.createElement('div', { style: { fontSize: '18px', marginBottom: '2px' } }, '●'),
                  window.React.createElement('div', { style: { fontSize: '9px' } }, (elem.label || 'Cercle').substring(0, 12))
                );
              } else if (elem.type === 'line') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '4px', boxSizing: 'border-box' } }, 
                  window.React.createElement('div', { style: { width: '70%', height: '1px', backgroundColor: borderColor, marginBottom: '4px' } }),
                  window.React.createElement('div', { style: { fontSize: '9px', color: '#666' } }, (elem.label || 'Ligne').substring(0, 12))
                );
              } else if (elem.type === 'image') {
                content = elem.src ? window.React.createElement('img', { src: elem.src, alt: 'Image', style: { width: '100%', height: '100%', objectFit: 'cover' }, onError: (e) => { e.target.src = ''; } }) : window.React.createElement('div', { style: { width: '100%', height: '100%', backgroundColor: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', color: '#999', fontSize: '11px', padding: '4px', boxSizing: 'border-box', textAlign: 'center' } }, 
                  window.React.createElement('div', { style: { fontSize: '18px', marginBottom: '4px' } }, '🖼️'),
                  window.React.createElement('div', { style: { fontSize: '9px' } }, (elem.label || 'Image').substring(0, 12))
                );
              } else {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', color: '#666', fontSize: '11px', padding: '8px', boxSizing: 'border-box', textAlign: 'center', whiteSpace: 'pre-wrap', wordBreak: 'break-word' } },
                  window.React.createElement('div', { style: { fontSize: '18px', marginBottom: '4px' } }, elem.icon || '□'),
                  window.React.createElement('div', { style: { fontSize: '10px', fontWeight: 'bold' } }, (elem.label || 'Élément').substring(0, 15))
                );
              }
              }
