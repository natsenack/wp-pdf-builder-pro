          ...
          window.React.createElement('div', { 
            ...
            canvasElements.map((elem) => {
              ...
              if (elem.type === 'text') {
                ...
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', padding: '6px', boxSizing: 'border-box', fontSize: '8px', color: '#666' } },
                  window.React.createElement('div', { style: { width: '50%', height: '50%', backgroundColor: '#000', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '1px', padding: '2px' } },
                    ...Array(16).fill(window.React.createElement('div', { style: { backgroundColor: Math.random() > 0.5 ? '#000' : '#fff' } }))
                  )
                );
              } else {
