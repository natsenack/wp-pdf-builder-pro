          ...
          window.React.createElement('div', { 
            ...
            canvasElements.map((elem) => {
              ...
              if (elem.type === 'text') {
                ...
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#666', fontSize: '12px', fontWeight: 'bold' } }, '▭');
              } else if (elem.type === 'circle') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#666', fontSize: '14px', fontWeight: 'bold' } }, '●');
              } else if (elem.type === 'line') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', paddingLeft: '4px' } }, window.React.createElement('div', { style: { width: '90%', height: '1px', backgroundColor: borderColor } }));
              } else if (elem.type === 'image') {
                content = elem.src ? window.React.createElement('img', { src: elem.src, alt: 'Image', style: { width: '100%', height: '100%', objectFit: 'cover' }, onError: (e) => { e.target.src = ''; } }) : window.React.createElement('div', { style: { width: '100%', height: '100%', backgroundColor: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#999', fontSize: '12px' } }, '🖼️');
              } else {
                content = null;
              }
