        ...
        return window.React.createElement('div', { style: { flex: 1, backgroundColor: '#d8d8d8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', overflow: 'auto' } },
          window.React.createElement('div', { 
            ...
            canvasElements.map((elem) => {
              ...
              const borderColor = elem.borderColor || '#999999';
              ...
              if (elem.type === 'text') {
                content = window.React.createElement('div', { style: { overflow: 'hidden', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: elem.textAlign || 'center', padding: '8px', boxSizing: 'border-box', color: elem.color || '#000000', fontSize: (elem.fontSize || 16) + 'px', fontWeight: elem.fontWeight || 'normal', fontStyle: elem.fontStyle || 'normal', textDecoration: elem.textDecoration || 'none', textAlign: elem.textAlign || 'left', whiteSpace: 'pre-wrap', wordBreak: 'break-word' } }, elem.text || 'Texte');
              } else if (elem.type === 'rectangle') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '6px', boxSizing: 'border-box', textAlign: 'center' } }, 
                  window.React.createElement('div', { style: { fontSize: '11px', color: '#333', fontWeight: 'normal', lineHeight: '1.3' } }, elem.label || '▭ Rectangle')
                );
              } else if (elem.type === 'circle') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '6px', boxSizing: 'border-box' } },
                  window.React.createElement('div', { style: { fontSize: '11px', color: '#333', fontWeight: 'normal' } }, elem.label || '● Cercle')
                );
              } else if (elem.type === 'line') {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '6px', boxSizing: 'border-box' } }, 
                  window.React.createElement('div', { style: { width: '80%', height: '1px', backgroundColor: borderColor, marginBottom: '4px' } }),
                  window.React.createElement('div', { style: { fontSize: '9px', color: '#999' } }, elem.label || 'Ligne')
                );
              } else if (elem.type === 'image') {
                content = elem.src ? window.React.createElement('img', { src: elem.src, alt: 'Image', style: { width: '100%', height: '100%', objectFit: 'cover' }, onError: (e) => { e.target.src = ''; } }) : window.React.createElement('div', { style: { width: '100%', height: '100%', backgroundColor: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', color: '#999', fontSize: '10px', padding: '6px', boxSizing: 'border-box', textAlign: 'center' } }, 
                  window.React.createElement('div', { style: { fontSize: '20px', marginBottom: '4px' } }, '🖼'),
                  window.React.createElement('div', { style: { fontSize: '9px' } }, elem.label || 'Image')
                );
              } else if (elem.type === 'table' || elem.label?.includes('Tableau')) {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', backgroundColor: '#f9f9f9', padding: '6px', boxSizing: 'border-box', fontSize: '9px', color: '#666' } },
                  window.React.createElement('div', { style: { width: '100%', borderCollapse: 'collapse', lineHeight: '1.2' } },
                    window.React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2px', marginBottom: '2px' } },
                      window.React.createElement('div', { style: { padding: '2px', backgroundColor: '#e0e0e0', fontSize: '8px', fontWeight: 'bold' } }, 'Col 1'),
                      window.React.createElement('div', { style: { padding: '2px', backgroundColor: '#e0e0e0', fontSize: '8px', fontWeight: 'bold' } }, 'Col 2'),
                      window.React.createElement('div', { style: { padding: '2px', backgroundColor: '#e0e0e0', fontSize: '8px', fontWeight: 'bold' } }, 'Col 3')
                    ),
                    window.React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2px' } },
                      window.React.createElement('div', { style: { padding: '2px', border: '1px solid #ddd', fontSize: '8px' } }, 'Données'),
                      window.React.createElement('div', { style: { padding: '2px', border: '1px solid #ddd', fontSize: '8px' } }, 'Données'),
                      window.React.createElement('div', { style: { padding: '2px', border: '1px solid #ddd', fontSize: '8px' } }, 'Données')
                    )
                  )
                );
              } else if (elem.type === 'barcode' || elem.label?.includes('Code')) {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', backgroundColor: '#fff', padding: '4px', boxSizing: 'border-box' } },
                  window.React.createElement('div', { style: { fontFamily: 'monospace', fontSize: '8px', letterSpacing: '2px', lineHeight: '1', marginBottom: '2px' } }, '|||||||'),
                  window.React.createElement('div', { style: { fontSize: '8px', color: '#666' } }, elem.label || 'Barcode')
                );
              } else if (elem.type === 'qrcode' || elem.label?.includes('QR')) {
                const qrPattern = Array(9).fill(null).map(() => window.React.createElement('div', { style: { width: '6px', height: '6px', backgroundColor: Math.random() > 0.5 ? '#000' : '#fff', margin: '1px', border: '1px solid #ccc' } }));
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', backgroundColor: '#fff', padding: '6px', boxSizing: 'border-box' } },
                  window.React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0px' } }, qrPattern),
                  window.React.createElement('div', { style: { fontSize: '8px', color: '#666', marginTop: '4px' } }, elem.label || 'QR Code')
                );
              } else {
                content = window.React.createElement('div', { style: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: '8px', boxSizing: 'border-box', textAlign: 'center', whiteSpace: 'pre-wrap', wordBreak: 'break-word', color: '#555', fontSize: '11px', lineHeight: '1.2' } },
                  window.React.createElement('div', { style: { fontSize: '14px', marginBottom: '4px' } }, elem.icon || '□'),
                  window.React.createElement('div', { style: { fontSize: '10px', fontWeight: '500' } }, (elem.label || 'Élément').substring(0, 20))
                );
              }
              }
              ...
              return window.React.createElement('div', { key: elem.id, 
                ...
                style: { position: 'absolute', left: elem.x + 'px', top: elem.y + 'px', width: elem.w + 'px', height: elem.h + 'px', backgroundColor: bgColor, border: borderWidth + 'px solid ' + (isSelected ? '#dc3545' : borderColor), borderRadius: borderRadius + 'px', boxSizing: 'border-box', cursor: draggingElementId === elem.id ? 'grabbing' : 'grab', overflow: 'hidden', userSelect: 'none', transform: 'rotate(' + (elem.rotation || 0) + 'deg)', opacity: (elem.opacity || 1), transition: draggingElementId === elem.id ? 'none' : 'border 0.1s', zIndex: zIndex }
              },
                content,
