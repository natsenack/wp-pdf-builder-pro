...
(function($) {
    ...
    // ✅ FIX: Fonction manquante openTemplateSettings
    window.openTemplateSettings = function(templateId) {
        console.log('[Template Settings] Opening settings for template:', templateId);
        ...
        if (modal) {
            ...
            // Charger les paramètres actuels du template si disponible
            if (typeof loadTemplateSettings === 'function') {
                loadTemplateSettings(templateId);
            }
        } else {
            console.error('[Template Settings] Modal not found');
        }
    };

    // ✅ FIX: Fonction manquante closeTemplateSettings
    window.closeTemplateSettings = function() {
        console.log('[Template Settings] Closing settings modal');
    ...
    // ✅ FIX: Fonction manquante saveTemplateSettings
    window.saveTemplateSettings = function() {
        console.log('[Template Settings] Saving template settings');
    ...
    // ✅ FIX: Fonction manquante loadTemplateSettings
    window.loadTemplateSettings = function(templateId) {
        console.log('[Template Settings] Loading settings for template:', templateId);

        // TODO: Charger les paramètres actuels du template
        // Pour l'instant, définir des valeurs par défaut
        document.getElementById('template-name-input').value = 'Template ' + templateId;
