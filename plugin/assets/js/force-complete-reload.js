...
(function($) {
    ...
    function checkCSSDeployment() {
        ...
        cssFiles.forEach(function(filename) {
            ...
            if (typeof pdfBuilderForceReload !== 'undefined' && pdfBuilderForceReload.pluginUrl) {
                baseUrl = pdfBuilderForceReload.pluginUrl + 'assets/css/';
                console.log('✅ Utilisation URL localisée pour', filename);
            } else {
                baseUrl = window.location.origin + '/wp-content/plugins/wp-pdf-builder-pro/plugin/assets/css/';
    ...
    function forceCompleteCSSReload() {
        ...
        var cssFiles = [
            ...
            'assets/css/modals-contenu.css',
            'assets/css/contenu-settings.css'
        ];
        ...
        var jsFiles = [
            'assets/js/canvas-card-monitor.js',
            'assets/js/pdf-preview-integration.js',
            'assets/js/settings-tabs.js',
            'assets/js/debug-css-modals.js'
        ];
    ...
    function emergencyCacheFix() {
        ...
        script.src = '/wp-content/plugins/wp-pdf-builder-pro/assets/js/canvas-card-monitor.js?v=' + timestamp + '&emergency=' + timestamp;
