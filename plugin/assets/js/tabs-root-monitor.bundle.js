...
return (Object(typeof self !== "undefined" ? self : this)["webpackChunkpdfBuilderReact"] = Object(typeof self !== "undefined" ? self : this)["webpackChunkpdfBuilderReact"] || []).push([["tabs-root-monitor"],{
...
(function () {
  ...
  var DEBUG = !!(window.PDF_BUILDER_CONFIG && window.PDF_BUILDER_CONFIG.debug);
  ...
  (function () {
    if (!Event.prototype.__pb_stopPatched) {
      ...
      var origStop = Event.prototype.stopPropagation;
  ...
  (function () {
    ...
    document.addEventListener('click', function (e) {
      try {
        var anchor = e.target.closest && e.target.closest('.nav-tab');
        if (anchor) {
