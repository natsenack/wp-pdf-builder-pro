        ...
        showTutorialSelectionModal() {
            ...
            const $modal = $(`
                <div id="pdf-builder-tutorial-menu" class="pdf-builder-modal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 999999;">
                    <div class="pdf-builder-modal-backdrop" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7);"></div>
                    <div class="pdf-builder-modal-content tutorial-menu-modal" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; border-radius: 12px; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); max-width: 600px; width: 90%; max-height: 80vh; overflow-y: auto;">
