    ...
    <header>
        ...
        <?php if (!$is_premium): ?>
            <div style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 4px; padding: 12px; margin: 15px 0; font-size: 14px;">
                ...
                Les statuts personnalisés restent disponibles. <a href="<?php echo admin_url('admin.php?page=pdf-builder-settings#licence'); ?>" style="color: #856404;">Passer à la version Premium</a> pour débloquer toutes les fonctionnalités.
            </div>
        <?php endif; ?>
    </header>
