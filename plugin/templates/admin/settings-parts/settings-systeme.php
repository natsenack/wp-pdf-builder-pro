            ...
            <form id="systeme-settings-form" method="post" action="">
                ...
                <div style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); border: 2px solid #e9ecef; border-radius: 12px; padding: 20px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <table class="form-table">
                        ...
                        <tr style="background-color: #fff3cd; border: 2px solid #ffeaa7; border-radius: 8px;">
                            <th scope="row"><label for="performance_auto_optimization" style="color: #856404; font-weight: bold;">🚀 Optimisation automatique des performances</label></th>
                            <td>
                                <label class="toggle-switch">
                                ...
                                <p class="description" style="color: #856404; font-weight: bold;">✅ FONCTIONNEL - Optimisation hebdomadaire automatique de la base de données et des ressources système</p>
                            </td>
                        </tr>
                        <tr>
