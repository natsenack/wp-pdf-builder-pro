<?php // Licence tab content - Updated: AJAX centralized 2025-12-02
    ...
    if (class_exists('PDF_Builder\Managers\PDF_Builder_License_Manager')) {
        ...
        $license_status = $license_info['status'] ?? 'inactive';
        $license_expires = $license_info['expires'] ?? '';
    }
?>

<!-- Section moderne de gestion de licence -->
<div class="pdfb-settings-content">
    <section class="pdfb-settings-section">
        <h3>
            <?php echo $is_premium ? '🌟' : '🔑'; ?> Gestion de la Licence
        </h3>
        <p>Gérez votre licence PDF Builder Pro et débloquez toutes les fonctionnalités premium.</p>

        <!-- Grille de cartes de présentation -->
        <div class="pdfb-settings-grid">
            <!-- Carte Statut de Licence -->
            <article class="pdfb-card">
                ...
                <main class="pdfb-card-content">
                    <?php if ($is_premium): ?>
                        <p>Votre licence Premium est active. Vous avez accès à toutes les fonctionnalités.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag active">✅ Actif</span>
                            <span class="pdfb-feature-tag active">🌟 Premium</span>
                            <span class="pdfb-feature-tag active">🔄 Mises à jour</span>
                        </div>
                    <?php else: ?>
                        <p>Vous utilisez la version gratuite. Activez une licence Premium pour débloquer toutes les fonctionnalités.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag">🔓 Limité</span>
                            <span class="pdfb-feature-tag">⚠️ Basique</span>
                        </div>
                    <?php endif; ?>
                </main>
                ...
                <footer class="pdfb-card-footer">
                    <?php if (!$is_premium): ?>
                        <a href="#activate-license" class="pdfb-card-btn pdfb-card-btn-primary">🔑 Activer une licence</a>
                    <?php else: ?>
                        <a href="#manage-license" class="pdfb-card-btn pdfb-card-btn-secondary">⚙️ Gérer</a>
                    <?php endif; ?>
                </footer>
            </article>

            <!-- Carte Fonctionnalités Premium -->
            <article class="pdfb-card">
                <header class="pdfb-card-header">
                    <div class="pdfb-card-header-left">
                    ...
                    <span class="pdfb-card-badge essential">Exclusif</span>
                </header>
                <main class="pdfb-card-content">
                    <p>Débloquez des fonctionnalités avancées pour maximiser votre productivité.</p>
                    <div class="pdfb-card-features">
                        <span class="pdfb-feature-tag <?php echo $is_premium ? 'active' : ''; ?>">📋 Templates illimités</span>
                        <span class="pdfb-feature-tag <?php echo $is_premium ? 'active' : ''; ?>">🔄 Tous les statuts</span>
                        <span class="pdfb-feature-tag <?php echo $is_premium ? 'active' : ''; ?>">💬 Support prioritaire</span>
                        <span class="pdfb-feature-tag <?php echo $is_premium ? 'active' : ''; ?>">🎨 Designs avancés</span>
                    </div>
                </main>
                <aside class="pdfb-card-preview">
                    <div class="pdfb-stats-grid" style="grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="pdfb-stat-card">
                            <div class="pdfb-stat-value">∞</div>
                            <div class="pdfb-stat-label">Templates</div>
                        </div>
                        <div class="pdfb-stat-card">
                            <div class="pdfb-stat-value">100%</div>
                            <div class="pdfb-stat-label">Fonctions</div>
                        </div>
                    </div>
                </aside>
                <footer class="pdfb-card-footer">
                    <a href="#features-list" class="pdfb-card-btn pdfb-card-btn-secondary">📖 Voir la liste</a>
                </footer>
            </article>
            ...
            <article class="pdfb-card">
                <header class="pdfb-card-header">
                    ...
                    <span class="pdfb-card-badge <?php echo $is_premium ? 'pro' : ''; ?>">
                        <?php echo $is_premium ? 'Prioritaire' : 'Communautaire'; ?>
                    </span>
                </header>
                <main class="pdfb-card-content">
                    <?php if ($is_premium): ?>
                        <p>Accédez au support prioritaire et à la documentation complète pour résoudre rapidement vos problèmes.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag active">⚡ Réponse rapide</span>
                            <span class="pdfb-feature-tag active">📚 Docs complètes</span>
                            <span class="pdfb-feature-tag active">🎓 Tutoriels</span>
                        </div>
                    <?php else: ?>
                        <p>Accédez à la documentation publique et aux forums communautaires pour obtenir de l'aide.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag">📚 Docs basiques</span>
                            <span class="pdfb-feature-tag">👥 Forum</span>
                        </div>
                    <?php endif; ?>
                </main>
                <aside class="pdfb-card-preview">
                ...
                <footer class="pdfb-card-footer">
                    <a href="https://docs.pdf-builder-pro.com" target="_blank" class="pdfb-card-btn pdfb-card-btn-secondary">📚 Documentation</a>
                    <?php if ($is_premium): ?>
                        <a href="https://support.pdf-builder-pro.com" target="_blank" class="pdfb-card-btn pdfb-card-btn-primary">💬 Contacter</a>
                    <?php endif; ?>
                </footer>
            </article>
            ...
            <article class="pdfb-card">
                <header class="pdfb-card-header">
                    ...
                    <span class="pdfb-card-badge <?php echo $is_premium ? 'new' : ''; ?>">
                        <?php echo $is_premium ? 'Actif' : 'Désactivé'; ?>
                    </span>
                </header>
                <main class="pdfb-card-content">
                    <?php if ($is_premium): ?>
                        <p>Recevez automatiquement les dernières fonctionnalités et correctifs de sécurité.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag active">✅ Auto-update</span>
                            <span class="pdfb-feature-tag active">🔒 Sécurité</span>
                            <span class="pdfb-feature-tag active">🎁 Nouvelles features</span>
                        </div>
                    <?php else: ?>
                        <p>Les mises à jour automatiques sont réservées aux licences Premium.</p>
                        <div class="pdfb-card-features">
                            <span class="pdfb-feature-tag">❌ Désactivé</span>
                            <span class="pdfb-feature-tag">⚠️ Manuel uniquement</span>
                        </div>
                    <?php endif; ?>
                </main>
                <aside class="pdfb-card-preview">
                ...
                <footer class="pdfb-card-footer">
                    <?php if ($is_premium): ?>
                        <a href="#check-updates" class="pdfb-card-btn pdfb-card-btn-primary">🔍 Vérifier</a>
                    <?php else: ?>
                        <a href="#upgrade" class="pdfb-card-btn pdfb-card-btn-primary">🌟 Passer à Premium</a>
                    <?php endif; ?>
                </footer>
            </article>
            ...
            <article class="pdfb-card">
                <header class="pdfb-card-header">
                    ...
                    <h4>Tarification</h4>
                    <span class="pdfb-card-badge advanced">Offres spéciales</span>
                </header>
                <main class="pdfb-card-content">
                    <p>Découvrez nos offres Premium flexibles adaptées à vos besoins professionnels.</p>
                    <div class="pdfb-card-features">
                        <span class="pdfb-feature-tag">💰 À partir de 49€/an</span>
                        <span class="pdfb-feature-tag">🎯 Licence site unique</span>
                        <span class="pdfb-feature-tag">🌐 Multi-sites</span>
                    </div>
                </main>
                <aside class="pdfb-card-preview">
                    <div class="pdfb-stats-grid" style="grid-template-columns: repeat(3, 1fr); gap: 8px;">
                        <div class="pdfb-stat-card">
                            <div class="pdfb-stat-value">49€</div>
                            <div class="pdfb-stat-label">Basic</div>
                        </div>
                        <div class="pdfb-stat-card">
                            <div class="pdfb-stat-value">99€</div>
                            <div class="pdfb-stat-label">Pro</div>
                        </div>
                        <div class="pdfb-stat-card">
                            <div class="pdfb-stat-value">199€</div>
                            <div class="pdfb-stat-label">Agency</div>
                        </div>
                    </div>
                </aside>
                <footer class="pdfb-card-footer">
                    <a href="https://pdf-builder-pro.com/pricing" target="_blank" class="pdfb-card-btn pdfb-card-btn-primary">💎 Voir les offres</a>
                </footer>
            </article>

            <!-- Carte Statistiques Licence -->
            ...
            <article class="pdfb-card">
                <header class="pdfb-card-header">
                    ...
                    <h4>Informations Licence</h4>
                    <span class="pdfb-card-badge">Détails</span>
                </header>
                <main class="pdfb-card-content">
                    <p>Consultez les informations détaillées de votre licence active.</p>
                    <div class="pdfb-card-features">
                        <span class="pdfb-feature-tag active">🔑 Clé: <?php echo substr($license_key, 0, 8) . '...'; ?></span>
                        <span class="pdfb-feature-tag active">📅 <?php echo $license_expires; ?></span>
                    </div>
                </main>
                <aside class="pdfb-card-preview">
                    <div class="pdfb-status-indicator active">
                        <span class="pdfb-status-dot"></span>
                        Licence valide jusqu'au <?php echo date('d/m/Y', strtotime($license_expires)); ?>
                    </div>
                </aside>
                <footer class="pdfb-card-footer">
                    <a href="#renew-license" class="pdfb-card-btn pdfb-card-btn-secondary">🔄 Renouveler</a>
                </footer>
            </article>
            <?php endif; ?>
        </div>
