...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function collectPdfSettings(formData) {
        ...
        const pdfQuality = document.querySelector('select[name="pdf_quality"]')?.value || 'high';
        const pdfPageSize = document.querySelector('select[name="pdf_page_size"]')?.value || 'A4';
        const pdfOrientation = document.querySelector('select[name="pdf_orientation"]')?.value || 'portrait';
        const pdfCacheEnabled = document.querySelector('input[name="pdf_cache_enabled"]')?.checked || false;
        const pdfCompression = document.querySelector('select[name="pdf_compression"]')?.value || 'medium';
        const pdfMetadataEnabled = document.querySelector('input[name="pdf_metadata_enabled"]')?.checked || true;
        const pdfPrintOptimized = document.querySelector('input[name="pdf_print_optimized"]')?.checked || true;
