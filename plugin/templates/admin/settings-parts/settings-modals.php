                ...
                <form id="canvas-grille-form">
                    <section>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="canvas_guides_enabled" name="pdf_builder_canvas_canvas_guides_enabled" value="1" <?php checked(get_option('pdf_builder_canvas_canvas_guides_enabled', '1'), '1'); ?>>
                                    <span class="toggle-slider"></span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch">
                                    <input type="checkbox" id="canvas_grid_enabled" name="pdf_builder_canvas_canvas_grid_enabled" value="1" <?php checked(get_option('pdf_builder_canvas_canvas_grid_enabled', '1'), '1'); ?>>
                                    <span class="toggle-slider"></span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="canvas_grid_size" name="pdf_builder_canvas_canvas_grid_size" value="<?php echo intval(get_option('pdf_builder_canvas_canvas_grid_size', 20)); ?>" min="5" max="100" <?php echo get_option('pdf_builder_canvas_canvas_grid_enabled', '1') !== '1' ? 'disabled' : ''; ?> />
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch <?php echo get_option('pdf_builder_canvas_canvas_grid_enabled', '1') !== '1' ? 'disabled' : ''; ?>">
                                    <input type="checkbox" id="canvas_snap_to_grid" name="pdf_builder_canvas_canvas_snap_to_grid" value="1" <?php checked(get_option('pdf_builder_canvas_canvas_snap_to_grid', '1'), '1'); ?> <?php echo get_option('pdf_builder_canvas_canvas_grid_enabled', '1') !== '1' ? 'disabled' : ''; ?>>
                                    <span class="toggle-slider"></span>
                                </label>
