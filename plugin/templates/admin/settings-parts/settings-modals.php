                ...
                <form id="canvas-autosave-form">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" id="canvas_autosave_interval" name="canvas_autosave_interval" value="<?php echo intval(get_option('pdf_builder_canvas_autosave_interval', 300) / 60); ?>" min="1" max="60" />
                            </td>
                        </tr>
                        <tr>
