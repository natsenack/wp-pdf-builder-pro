...
?>
            ...
            <script src="<?php echo esc_url(PDF_BUILDER_PRO_ASSETS_URL . 'js/canvas-settings-debug.js'); ?>?v=<?php echo time(); ?>"></script>
            ...
            <script>
                ...
                console.log('Canvas settings script URL:', '<?php echo esc_url(PDF_BUILDER_PRO_ASSETS_URL . 'js/canvas-settings-debug.js'); ?>?v=<?php echo time(); ?>');
            </script>
