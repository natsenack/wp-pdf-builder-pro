...
<?php
    ...
    // Injecter l'API JavaScript dans le head pour s'assurer qu'elle est disponible
    add_action('admin_head', function() {
        ?>
        <script>
        console.log('PDFBuilderTabsAPI admin_head script starting...');
        ...
        try {
            ...
            console.log('PDFBuilderTabsAPI defined successfully in admin_head:', window.PDFBuilderTabsAPI);
        } catch (error) {
            console.error('Error in PDFBuilderTabsAPI definition in admin_head:', error);
        }
        </script>
        <?php
    });
