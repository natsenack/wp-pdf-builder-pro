...
if ((isset($_POST['submit']) && isset($_POST['pdf_builder_settings_nonce'])) || (isset($_POST['action']) && $_POST['action'] === 'pdf_builder_save_settings')) {
    ...
    if (wp_verify_nonce($nonce_to_check, 'pdf_builder_settings')) {
        ...
        if (defined('WP_DEBUG') && WP_DEBUG) {
            error_log('PDF Builder: Received debug fields - developer_enabled: ' . (isset($_POST['pdf_builder_developer_enabled']) ? $_POST['pdf_builder_developer_enabled'] : 'NOT_SET'));
        }
            ...
            PDF_Builder_Ajax_Handler.makeRequest(formData, {
                ...
                successCallback: function(result, originalData) {
                    ...
                    if (savedSettings && typeof savedSettings === 'object') {
                        ...
                        console.log('[AJAX DEBUG] Checking result.data:', result.data);
                        if (result && result.data && result.data.debug_logs) {
                            ...
                            console.log('[AJAX DEBUG] No debug_logs in response');
                        }
