...
// Récupérer les paramètres canvas depuis les options WordPress séparées (pour cohérence avec les modales)
$canvas_settings_js = [
    ...
    'show_grid' => get_option('pdf_builder_canvas_grid_enabled', false) === '1',
    'grid_size' => intval(get_option('pdf_builder_canvas_grid_size', 10)),
    'grid_color' => get_option('pdf_builder_canvas_grid_color', '#e0e0e0'),
    'snap_to_grid' => get_option('pdf_builder_canvas_snap_to_grid', false) === '1',
    ...
    'show_guides' => get_option('pdf_builder_canvas_guides_enabled', false) === '1',
    ...
    'zoom_with_wheel' => get_option('pdf_builder_canvas_zoom_with_wheel', false) === '1',
    'pan_with_mouse' => get_option('pdf_builder_canvas_pan_enabled', false) === '1',
    'show_resize_handles' => get_option('pdf_builder_canvas_resize_enabled', false) === '1',
    ...
    'enable_rotation' => get_option('pdf_builder_canvas_rotate_enabled', false) === '1',
    'rotation_step' => intval(get_option('pdf_builder_canvas_rotation_step', 15)),
    'multi_select' => get_option('pdf_builder_canvas_multi_select', false) === '1',
    'copy_paste_enabled' => get_option('pdf_builder_canvas_copy_paste', false) === '1',
    'export_quality' => get_option('pdf_builder_canvas_export_quality', 'print'),
    'export_format' => get_option('pdf_builder_canvas_export_format', 'pdf'),
    ...
    'enable_hardware_acceleration' => get_option('pdf_builder_canvas_hardware_acceleration', true) === '1',
    'limit_fps' => get_option('pdf_builder_canvas_limit_fps', true) === '1',
    'max_fps' => intval(get_option('pdf_builder_canvas_fps_target', 60)),
    'auto_save_enabled' => get_option('pdf_builder_canvas_autosave_enabled', false) === '1',
    'auto_save_interval' => intval(get_option('pdf_builder_canvas_autosave_interval', 30)),
    'auto_save_versions' => intval(get_option('pdf_builder_canvas_autosave_versions', 10)),
    ...
    'debug_mode' => get_option('pdf_builder_canvas_debug_enabled', false) === '1',
    'show_fps' => get_option('pdf_builder_canvas_performance_monitoring', false) === '1'
];
