<?php
/**
 * PDF BUILDER PRO - SETTINGS MAIN (ULTRA-SIMPLE - FINAL FIX)
 * Version ultra-basique pour diagnostiquer et corriger le problème
 */
...
<?php
// Enqueue the external JS file for tab navigation
wp_enqueue_script(
    'pdf-builder-tabs',
    plugin_dir_url(dirname(dirname(__FILE__))) . 'assets/js/settings-tabs.js',
    ['jquery'],
    filemtime(plugin_dir_path(dirname(dirname(__FILE__))) . 'assets/js/settings-tabs.js'),
    true
);
?>
