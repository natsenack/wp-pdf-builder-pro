...
<div class="wrap">
    ...
    <form method="post" class="settings-form" id="settings-form">
        ...
        <div id="developpeur" class="tab-content" style="display: none;">
            ...
            <div style="background: #ffebee; border-left: 4px solid #d32f2f; border-radius: 4px; padding: 20px; margin-bottom: 30px;">
                <h3 style="margin-top: 0; color: #c62828;">🚨 Mode Développeur - Usage Restreint</h3>
                <p style="margin: 10px 0; color: #c62828;">
                    Ces outils sont réservés aux développeurs. Ils peuvent affecter les performances et la sécurité du site.
                </p>
                <ul style="margin: 0; padding-left: 20px; color: #c62828;">
                    <li>❌ Ne jamais laisser activé en production</li>
                    <li>❌ Désactiver après débogage terminé</li>
                    <li>✅ Utiliser uniquement pour le développement</li>
                </ul>
            </div>
            
            <h3 style="margin-top: 30px; border-bottom: 1px solid #e5e5e5; padding-bottom: 10px;">🔐 Accès Développeur</h3>
                        ...
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="developer_enabled" name="developer_enabled" value="1" 
                                       <?php checked($settings['developer_enabled'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Active tous les outils de développement et de débogage</div>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="developer_password">Mot de Passe Développeur</label></th>
                    <td>
                        <input type="password" id="developer_password" name="developer_password" 
                               value="<?php echo esc_attr($settings['developer_password'] ?? ''); ?>" 
                               class="regular-text" />
                        <button type="button" id="toggle_password" class="button button-secondary" style="margin-left: 10px;">
                            👁️ Afficher
                        </button>
                        <p class="description">Mot de passe requis pour accéder aux outils développeur (optionnel)</p>
                    </td>
                </tr>
            </table>
            
            <h3 style="margin-top: 30px; border-bottom: 1px solid #e5e5e5; padding-bottom: 10px;">🐛 Débogage PHP</h3>
            
            <table class="form-table">
                <tr>
                    <th scope="row"><label for="debug_php_errors">Debug Erreurs PHP</label></th>
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="debug_php_errors" name="debug_php_errors" value="1" 
                                       <?php checked($settings['debug_php_errors'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Affiche les erreurs PHP détaillées (équivalent WP_DEBUG)</div>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="debug_performance">Debug Performance</label></th>
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="debug_performance" name="debug_performance" value="1" 
                                       <?php checked($settings['debug_performance'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Affiche les métriques de performance (temps d'exécution, mémoire)</div>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="debug_database">Debug Base de Données</label></th>
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="debug_database" name="debug_database" value="1" 
                                       <?php checked($settings['debug_database'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Log toutes les requêtes SQL exécutées</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="enable_profiling" name="enable_profiling" value="1" 
                                       <?php checked($settings['enable_profiling'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Active le profiling PHP avec Xdebug (impact performance)</div>
                    </td>
                </tr>
            </table>
            
            <h3 style="margin-top: 30px; border-bottom: 1px solid #e5e5e5; padding-bottom: 10px;">🌐 Débogage JavaScript</h3>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="debug_javascript" name="debug_javascript" value="1" 
                                       <?php checked($settings['debug_javascript'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Active les logs détaillés JavaScript dans la console</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="debug_ajax" name="debug_ajax" value="1" 
                                       <?php checked($settings['debug_ajax'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Log toutes les requêtes AJAX avec leurs réponses</div>
                    </td>
                </tr>
            </table>
            
            <h3 style="margin-top: 30px; border-bottom: 1px solid #e5e5e5; padding-bottom: 10px;">📋 Configuration Logs</h3>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Niveau minimum des messages à logger</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="log_file_size">Taille Max Fichier Log (MB)</label></th>
                    <td>
                        <input type="number" id="log_file_size" name="log_file_size" 
                               value="<?php echo intval($settings['log_file_size'] ?? 10); ?>" min="1" max="100" />
                        <p class="description">Taille maximale d'un fichier de log avant rotation</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="log_retention">Rétention Logs (jours)</label></th>
                    <td>
                        <input type="number" id="log_retention" name="log_retention" 
                               value="<?php echo intval($settings['log_retention'] ?? 30); ?>" min="1" max="365" />
                        <p class="description">Nombre de jours à conserver les anciens logs</p>
                    </td>
                </tr>
            </table>
            
            <h3 style="margin-top: 30px; border-bottom: 1px solid #e5e5e5; padding-bottom: 10px;">🔧 Options Avancées</h3>
            
            <table class="form-table">
                <tr>
                    <th scope="row"><label for="disable_hooks">Hooks à Désactiver</label></th>
                    <td>
                        <input type="text" id="disable_hooks" name="disable_hooks" 
                               value="<?php echo esc_attr($settings['disable_hooks'] ?? ''); ?>" 
                               class="regular-text" placeholder="hook1,hook2,hook3" />
                        <p class="description">Liste des hooks WordPress à désactiver (séparés par virgules)</p>
                    </td>
                </tr>
                <tr>
                        ...
                        <div class="toggle-container">
                            <label class="toggle-switch">
                                <input type="checkbox" id="force_https" name="force_https" value="1" 
                                       <?php checked($settings['force_https'] ?? false); ?> />
                                <span class="toggle-slider"></span>
                            </label>
                            <span class="toggle-label">Activé</span>
                        </div>
                        <div class="toggle-description">Force les appels API externes en HTTPS</div>
                    </td>
                </tr>
            </table>
            
            <!-- Conseils développeur -->
            <div style="background: #f3e5f5; border-left: 4px solid #7b1fa2; border-radius: 4px; padding: 20px; margin-top: 30px;">
                <h3 style="margin-top: 0; color: #7b1fa2;">💡 Conseils Développeur</h3>
                <ul style="margin: 0; padding-left: 20px; color: #7b1fa2;">
                    <li><strong>Debug PHP :</strong> Activez uniquement pour identifier les erreurs serveur</li>
                    <li><strong>Debug JS :</strong> Utilisez la console développeur (F12) pour voir les logs</li>
                    <li><strong>Performance :</strong> Le profiling impacte significativement les performances</li>
                    <li><strong>Logs :</strong> Surveillez la taille des fichiers de log en production</li>
                    <li><strong>Sécurité :</strong> Désactivez toujours le mode développeur en production</li>
                </ul>
            </div>
        </div>
