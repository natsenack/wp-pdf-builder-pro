...
// Paramètres développeur
    ...
    public function enqueueAdminScripts($hook)
    {
        ...
        // Déterminer l'URL du plugin
        $plugin_dir_url = plugin_dir_url(dirname(__FILE__, 3) . '/pdf-builder-pro.php');
        
        // Scripts personnalisés
        wp_enqueue_script('pdf-builder-predefined-templates', $plugin_dir_url . 'templates/admin/js/predefined-templates.js', ['jquery', 'codemirror'], '1.0.0', true);
        // Styles personnalisés
        wp_enqueue_style('pdf-builder-predefined-templates', $plugin_dir_url . 'templates/admin/css/predefined-templates.css', [], '1.0.0');
        // Localize script
