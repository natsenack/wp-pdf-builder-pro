            ...
            <div style="background: white; border-radius: 12px; max-width: 550px; width: 95%; padding: 40px; box-shadow: 0 20px 60px rgba(0,0,0,0.3); position: relative; max-height: 85vh; overflow-y: auto;">
                ...
                <div style="display: flex; gap: 10px; justify-content: space-between;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        <button id="pdf-builder-btn-proceed" type="button" class="button button-primary" style="padding: 10px 20px; background: #667eea; border-color: #667eea; color: white; cursor: default; opacity: 0.6;">Désactiver</button>
                    </div>
                </div>
            </div>
        </div>
