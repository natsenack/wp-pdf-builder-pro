...
class PDF_Builder_Template_Migrator
{
     ...
     */
    public static function migrateTemplateData($template_data)
    {
     ...
     */
    public static function migrateAllTemplates()
    {
        global $wpdb;
        ...
        $results = $wpdb->get_results($query); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.PreparedSQLPlaceholders.LikeWildcardsInQuery
        ...
        foreach ($results as $row) {
            ...
            $migrated = self::migrateTemplateData($template_data);
     ...
     */
    public static function migrateGlobalTemplates()
    {
        global $wpdb;
