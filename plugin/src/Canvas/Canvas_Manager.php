...
/** @var array Paramètres canvas en cache */
    ...
    private function loadSettings()
    {
        ...
        $this->settings = [
            ...
            'enable_rotation' => ($settings['pdf_builder_canvas_rotate_enabled'] ?? '0') == '1',
            ...
            'auto_crop' => ($settings['pdf_builder_canvas_auto_crop'] ?? '0') == '1',
            ...
            'debug_mode' => ($settings['pdf_builder_canvas_debug_mode'] ?? '0') == '1',
            'show_fps' => ($settings['pdf_builder_canvas_show_fps'] ?? '0') == '1'
        ];
    }
