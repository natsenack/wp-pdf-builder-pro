...
/** @var array Paramètres canvas en cache */
    ...
    private function loadSettings()
    {
        ...
        $this->settings = [
            ...
            'default_canvas_width' => intval(get_option('pdf_builder_canvas_canvas_width', 794)),
            'default_canvas_height' => intval(get_option('pdf_builder_canvas_canvas_height', 1123)),
            'canvas_background_color' => get_option('pdf_builder_canvas_canvas_bg_color', '#ffffff'),
            ...
            'border_width' => intval(get_option('pdf_builder_canvas_canvas_border_width', 1)),
            'shadow_enabled' => get_option('pdf_builder_canvas_canvas_shadow_enabled', '0') == '1',
            ...
            'show_grid' => get_option('pdf_builder_canvas_canvas_grid_enabled', '1') == '1',
            'grid_size' => intval(get_option('pdf_builder_canvas_canvas_grid_size', 20)),
