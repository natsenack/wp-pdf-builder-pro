...
/** @var array Paramètres canvas en cache */
    ...
    private function loadSettings()
    {
        ...
        $is_free_license = !$license_manager->isPremium();
        ...
        $this->settings = [
            ...
            // Valeurs par défaut pour licence gratuite
            'container_background_color' => $is_free_license ? '#f8f9fa' : ($settings['pdf_builder_canvas_container_bg_color'] ?? '#f8f9fa'),
            'container_show_transparency' => $is_free_license ? false : (($settings['pdf_builder_canvas_container_show_transparency'] ?? '0') == '1'),
            'border_color' => $is_free_license ? '#cccccc' : ($settings['pdf_builder_canvas_border_color'] ?? '#cccccc'),
            'border_width' => $is_free_license ? 1 : intval($settings['pdf_builder_canvas_border_width'] ?? 1),
            ...
            'show_grid' => ($settings['pdf_builder_canvas_grid_enabled'] ?? '1') == '1',
            ...
            'show_guides' => ($settings['pdf_builder_canvas_guides_enabled'] ?? '1') == '1',
