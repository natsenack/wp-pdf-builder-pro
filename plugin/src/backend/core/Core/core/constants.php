 ...
 * This function checks if WooCommerce plugin is installed and active
 */
if (!function_exists('pdf_builder_is_woocommerce_active')) {
    function pdf_builder_is_woocommerce_active() {
        // Check if WooCommerce is active using standard WordPress function
        if (function_exists('is_plugin_active')) {
            return is_plugin_active('woocommerce/woocommerce.php');
        }

        // Fallback: check if WC_VERSION constant is defined
