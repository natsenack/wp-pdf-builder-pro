...
function pdf_builder_check_advanced_systems_status() {
    $systems_status = array(
        ...
        'security_validator' => class_exists('PDF_Builder\\Core\\PDF_Builder_Security_Validator') && \PDF_Builder\Core\PDF_Builder_Security_Validator::get_instance() !== null,
        ...
        'backup_recovery' => class_exists('PDF_Builder_Backup_Recovery_System') && PDF_Builder_Backup_Recovery_System::get_instance() !== null,
