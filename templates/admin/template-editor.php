...
// Plus besoin d'enqueues ici car ils sont déjà faits avant wp_head()
    ...
    echo '<script type="text/javascript" src="' . esc_url(plugins_url('assets/js/bundle-minimal-test.js', dirname(dirname(__FILE__)))) . '"></script>';
    echo '<script type="text/javascript" src="' . esc_url(plugins_url('bundle-execution-test.js', dirname(__FILE__))) . '"></script>';
